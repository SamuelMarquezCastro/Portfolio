...
const translations = {
  nl: {
    ...
    workTitle: 'Projecten waarin identiteit en gebruik samenkomen.',
    workIntro: 'Een selectie van digitaal productontwerp en visuele identiteit. De uitgebreide case studies bouwen we verder uit.',
  ...
  en: {
    ...
    workTitle: 'Projects where identity and usability come together.',
    workIntro: 'A selection of digital product design and visual identity. The full case studies will be developed further.',
