...
const translations = {
  nl: {
    ...
    caseOverviewTitle: 'Een eigen appconcept voor Lumière.',
    ...
    caseFlowCaption: 'De informatiestructuur van het appconcept. Scroll horizontaal om het schema in detail te bekijken.',
    ...
    caseOutcomeTitle: 'Een interactief prototype als resultaat.',
  ...
  en: {
    ...
    caseOverviewTitle: 'An original app concept for Lumière.',
    ...
    caseFlowCaption: 'The information structure of the app concept. Scroll horizontally to explore the diagram in detail.',
    ...
    caseOutcomeTitle: 'An interactive prototype as the outcome.',
